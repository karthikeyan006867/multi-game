...
export default function TexasHoldemPokerGame() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('poker_high_score');
  ...
  const handleGameOver = () => {
    ...
    if (score > highScore) {
      setHighScore(score);
      localStorage.setItem('poker_high_score', score.toString());
      confetti({
        particleCount: 100,
        spread: 70,
        origin: { y: 0.6 }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
          ...
          <p className="text-gray-300">
            Texas Hold'em Poker is an exciting game! Use arrow keys or controls to play.
