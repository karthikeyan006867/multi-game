...
export default function BlackjackGame() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('blackjack_high_score');
  ...
  useEffect(() => {
    ...
    const gameLoop = () => {
      ...
      ctx.fillStyle = '#fff';
      ctx.font = '24px Arial';
      ctx.fillText('Blackjack 21', canvas.width / 2 - 80, canvas.height / 2);
  ...
  const handleGameOver = () => {
    ...
    if (score > highScore) {
      setHighScore(score);
      localStorage.setItem('blackjack_high_score', score.toString());
      confetti({
        particleCount: 100,
        spread: 70,
        origin: { y: 0.6 }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
          ...
          <p className="text-gray-300">
            Blackjack 21 is an exciting game! Use arrow keys or controls to play.
